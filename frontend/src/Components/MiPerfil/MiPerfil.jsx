                ...
                <div>
                    ...
                    <div className="flex flex-col justify-evenly h-[150px]">
                                ...
                                <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                                    <li className="flex flex-col justify-center">
                                       ...
                                       <div className="flex flex-row justify-end gap-10">
                                            <button><img src="../../../src/Images/edit.png" alt="add" width="20" height="20"/></button>
                                            <button><img src="../../../src/Images/delete.png" alt="add" width="20" height="20"/></button>
                                       </div>
                                    </li>
                                    <li className="flex flex-col justify-center">
                        ...
                        <Link to="editar-direcciones">
                            ...
                            type="button">
                            Agregar Direccion 
                            <img src="../../../src/Images/PlusCircle.png" alt="add" width="20" height="20"/>
                            </button>
                        </Link>
                    </div>
                </div>
